...
function() {
    ...
    e = function c() {
        function x() {
            ...
            e && (e.style.transitionDuration = ~~b.autoClose + "ms", e.classList.add("mini-dialog-autoclose-active"), e.addEventListener("transitionend",
            function() {
                c.close(n, m)
            }))
        }
        ...
        if (k) {
            ...
            N = !!(430 > B);
            if (e > B || f) e = B;
            g.style.width = e + "px"; ! N || f || b.WAITING || (g.style.width = B - 60 + "px");
    ...
    e.ok = function(c) {
        ...
        if (e) {
            ...
            function() {
                e.classList.contains("mini-dialog-notclose") ? (e.style.pointerEvents = "none", k && c(e)) : d(".mini-dialog-shortcuts-mark").addEventListener("animationend",
                function() {
                    k && c()
                })
            })
